/*
	Script that handles the scene creation(with model objects), shader parsing and binding,
	creation of framebuffers and textures, camera handling and controls (with key listeners)
					
					(with all the vector, matrix and async operations)	
*/
